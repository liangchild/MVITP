...
class TrainMeter(object):
    ...
    def log_iter_stats(self, cur_epoch, cur_iter):
        ...
        if not self._cfg.DATA.MULTI_LABEL:
            ...
            mean_top1_err = self.num_top1_mis / self.num_samples
            mean_top5_err = self.num_top5_mis / self.num_samples
            stats["mean_top1_err"] = mean_top1_err
            stats["mean_top5_err"] = mean_top5_err
        if self.multi_loss is not None:
